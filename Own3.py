...
while drive:
    ...
    down_px=window.get_at((cam_x,cam_y+focal_dist))[0]              #down er ses er bindu ta nirdharon korlam
    right_px=window.get_at((cam_x+focal_dist,cam_y))[0]             #Right site er ses bindu ta nirnoy korlam
...
#ekhane garitake chalabo mane garita cholbe
